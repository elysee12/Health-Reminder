...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    // ── Dashboard subtitles ──
    'provider_dashboard_subtitle': 'Hypertension Management Dashboard',
    'admin_dashboard_subtitle': 'System Administration Dashboard',
    // ── Patient dashboard ──
    ...
    'keep_it_up_msg': "Taking your medication consistently helps control your blood pressure. You're doing great!",
    ...
    'system_admin_subtitle': 'System Administration Dashboard',
    'click_to_review': 'Click to review',
    // ── Stat card subs ──
    'awaiting_confirmation': 'Awaiting confirmation',
    'needs_follow_up': 'Needs follow-up',
    'below_70_adherence': 'Below 70% adherence',
    // ── Stat card trends ──
    'trend_up': '+12% this week',
    'trend_down': '-5% this week',
    'trend_neutral': 'No change',
    // ── Login page left panel ──
    'rwanda_health_platform': 'Rwanda Health Platform',
    'reminders_sent': 'Reminders Sent',
    'health_centers': 'Health Centers',
    'real_time_bp': 'Real-time BP monitoring',
    'sms_reminders': 'SMS medication reminders',
    'adherence_95': '95% adherence rate',
    // ── Misc ──
    'active_label': 'active',
    ...
    'no_reminders_scheduled': 'No reminders scheduled yet. Your reminders will appear here.',
    'create_prescriptions_hint': 'Create prescriptions to generate patient reminders.',
    'your_prescriptions': 'Your Prescriptions',
    'view_manage_reminders': 'View and manage your medication reminders by prescription',
    'no_history_found': 'No medication history available yet.',
    'unable_to_load_dashboard': 'Unable to Load Dashboard',
    'connection_issue_message': 'There was a problem connecting to the server. Please check your internet connection and try again.',
    'retry': 'Retry',
  },
  rw: {
    'dashboard': 'Ikibaho',
    ...
    'patient': 'Umurwayi',
    'provider': 'Umuganga w\'Ubuzima Rusange',
    ...
    // ── Dashboard subtitles ──
    'provider_dashboard_subtitle': "Ikibaho cyo Gucunga Umuvuduko w'Amaraso",
    'admin_dashboard_subtitle': "Ikibaho cy'Ubuyobozi bwa Sisitemu",
    // ── Patient dashboard ──
    'good_morning': 'Mwaramutse',
    'good_afternoon': 'Mwiriwe',
    'good_evening': 'Mwiriwe',
    'weekly_trend': "Imiterere y'icyumweru",
    'keep_it_up': 'Komeza!',
    'keep_it_up_msg': "Gufata imiti yawe buri gihe bifasha kugenzura umuvuduko w'amaraso. Urakora neza!",
    'no_upcoming_appointments': 'Nta gahunda na muganga iri imbere',
    'book_appointment': 'Fata Gahunda',
    'no_active_goals': 'Nta ntego zihari',
    'target': 'Intego',
    'complete': 'byarangiye',
    'quick_access': 'Injira Vuba',
    'visits': 'Gahunda',
    'goals': 'Intego',
    // ── Provider dashboard ──
    'taken_label': 'Yafashwe',
    'missed_label': 'Yaburiwe',
    'adherence_trend': "Imiterere y'ubukurikire",
    'last_7_days': 'Iminsi 7 ishize',
    'quick_actions': 'Ibikorwa Vuba',
    'no_patients_found': 'Nta barwayi babonetse',
    // ── Admin dashboard ──
    'role': 'Uruhare',
    'user_distribution': "Ikwirakwizwa ry'abakoresha",
    'system_admin_subtitle': "Ikibaho cy'Ubuyobozi bwa Sisitemu",
    'click_to_review': 'Kanda usuzume',
    // ── Stat card subs ──
    'awaiting_confirmation': 'Itegereje kwemezwa',
    'needs_follow_up': 'Igusaba gukurikirana',
    'below_70_adherence': 'Munsi ya 70% ubukurikire',
    // ── Stat card trends ──
    'trend_up': '+12% iki cyumweru',
    'trend_down': '-5% iki cyumweru',
    'trend_neutral': 'Nta hinduka',
    // ── Login page left panel ──
    'rwanda_health_platform': "Urubuga rw'Ubuzima rw'u Rwanda",
    'reminders_sent': 'Ibibutsa Byoherejwe',
    'health_centers': "Ibigo by'Ubuvuzi",
    'real_time_bp': 'Gukurikirana umuvuduko',
    'sms_reminders': "Ibibutsa by'imiti SMS",
    'adherence_95': 'Ubukurikire bwa 95%',
    // ── Misc ──
    'active_label': 'irakoreshwa',
    'reminders_label': 'Ibibutsa',
    'avg_label': 'hagati',
    'patients_label': 'Abarwayi',
    // ── DB enum values ──
    'taken':        'Yafashwe',
    'missed':       'Yaburiwe',
    'pending':      'Itegereje',
    ...
    'Male':         'Gabo',
    'Female':       'Gore',
    'prescribed_by': 'Yanditswe na',
    'no_reminders_scheduled': 'Nta miburo yateganijwe. Ibibutsa byawe bizagaragara hano.',
    'create_prescriptions_hint': "Andika imiti kugira ngo ubone ibibutsa by'abarwayi.",
    'your_prescriptions': 'Imiti yawe',
    'view_manage_reminders': 'Reba no kugerekeza ibibutsa byawe bya miti',
    'no_history_found': "Nta mateka y'imiti ahari ubu.",
  },
};
